...
import inca.jesus.alianza17.ServerConexion.MiEquipo_Eliminar;

public class AdapterMantMisEquipos extends RecyclerView.Adapter<AdapterMantMisEquipos.ViewHolder> {
    private Context context;
    private List<MantenimientoCategoria> my_Data;
    private RecyclerViewOnItemClickListener2 recyclerViewOnItemClickListener;
    private boolean Select=false;

    public AdapterMantMisEquipos(Context context, List<MantenimientoCategoria> my_Data, RecyclerViewOnItemClickListener2
    ...
    public AdapterMantMisEquipos.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView= LayoutInflater.from(parent.getContext()).inflate(R.layout.card_mant_categorias,parent,false);
        return new AdapterMantMisEquipos.ViewHolder(itemView);

    }
    @Override
    public void onBindViewHolder(AdapterMantMisEquipos.ViewHolder holder, final int position) {
    ...
    private void Eliminar_Categoria(int i) {
        ...
        MiEquipo_Eliminar Server = new MiEquipo_Eliminar (id, responseListener);
