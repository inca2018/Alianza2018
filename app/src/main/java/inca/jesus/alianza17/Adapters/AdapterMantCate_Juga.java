...
public class AdapterMantCate_Juga extends RecyclerView.Adapter<AdapterMantCate_Juga.ViewHolder> {
    private Context context;
    private List<Plantel> my_Data;
    private RecyclerViewOnItemClickListener2 recyclerViewOnItemClickListener;
    boolean Selecto=false;

    public AdapterMantCate_Juga(Context context, List<Plantel> my_Data, RecyclerViewOnItemClickListener2
    ...
    public AdapterMantCate_Juga.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView= LayoutInflater.from(parent.getContext()).inflate(R.layout.card_mant_jugadores2,parent,false);
        return new AdapterMantCate_Juga.ViewHolder(itemView);

    }
    @Override
    public void onBindViewHolder(AdapterMantCate_Juga.ViewHolder holder, final int position) {
