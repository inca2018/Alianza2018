...
import inca.jesus.alianza17.Adapters.AdapterMantMisEquipos;
...
import inca.jesus.alianza17.ServerConexion.MiEquipo_Eliminar_Jugador;
import inca.jesus.alianza17.ServerConexion.MiEquipo_Insertar;
import inca.jesus.alianza17.ServerConexion.MiEquipo_Insertar_Jugador;
 ...
 */
public class FragmentMisEquipos extends Fragment implements  SearchView.OnQueryTextListener, MenuItem.OnActionExpandListener {

    RecyclerView recycler,recycler2,recycler3;
    AdapterMantMisEquipos adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_mis_equipos, container, false);
        variables(v);
        recycler_lista();
    ...
    private void regreso_a_categ() {
        ...
        btn_regre_Cat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                add.setVisible(true);
                ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Mis Equipos");
            }
        });
    }
    private void variables(View v) {
        ...
        card_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressDialog.setMessage("Guardando Jugadores....");
                progressDialog.show();
    ...
    private void Agregar_Jugador_Categoria(int cod_juga) {
        ...
        MiEquipo_Insertar_Jugador Server = new MiEquipo_Insertar_Jugador(d1,d2, responseListener);
    ...
    private void Eliminar_Jugador_de_equipo() {
        ...
        guardar_nueva_categ.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(nom_categ.getText().toString().length()==0){
                    Toast.makeText(getActivity(),"Ingrese Nombre de Equipo, para continuar!", Toast.LENGTH_SHORT).show();
                }else{
    ...
    private void Insert_Categoria_Bd(MantenimientoCategoria temp) {
        ...
        MiEquipo_Insertar Server = new MiEquipo_Insertar(d1,d2,d3,d4, responseListener);
        RequestQueue queue = Volley.newRequestQueue(getActivity());
        queue.add(Server);
        Listar_Categorias();
    }
    private void recycler_lista() {
        linear = new LinearLayoutManager(mContext, LinearLayoutManager.VERTICAL,false);
        adapter = new AdapterMantMisEquipos(mContext,LIST_TEMP, new RecyclerViewOnItemClickListener2() {
            @Override
            public void onClick(View v, int position) {
            }
        });
    ...
    private void Listar_Categorias() {
        ...
        AsyncTask<Integer,Void,Void> task = new AsyncTask<Integer, Void, Void>() {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                progressDialog = new ProgressDialog(getActivity());
                progressDialog.setTitle("Mis Equipos");
                progressDialog.setMessage("Listando Mis Equipos....");
                progressDialog.show();
            }
            protected void onPostExecute(Void aVoid){
    ...
    private void Eliminar_Jugador(int i) {
        ...
        MiEquipo_Eliminar_Jugador Server = new MiEquipo_Eliminar_Jugador(id,id2, responseListener);
        RequestQueue queue = Volley.newRequestQueue(getActivity());
        queue.add(Server);
    }
