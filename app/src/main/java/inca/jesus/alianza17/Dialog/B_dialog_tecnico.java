...
public class B_dialog_tecnico extends AppCompatActivity {

    int tec1,tec2,tec3,tec4,tec5,tec6;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_b_dialog_tecnico);
        mostrar_hab();
    }
    ...
    private void mostrar_hab() {
        ...
        btntec.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(B_dialog_tecnico.this,B_A4_Diagnostico.class);
