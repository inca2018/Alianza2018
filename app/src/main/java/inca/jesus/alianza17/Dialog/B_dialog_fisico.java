...
public class B_dialog_fisico extends AppCompatActivity {

    int res1,res2,res3,res4,res5,res6,res7;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_b_dialog_fisico);
    ...
    private void mostrar_hab() {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(B_dialog_fisico.this,B_A4_Diagnostico.class);
