...
public class B_dialog_capacidad extends AppCompatActivity {

    int resc1,resc2,resc3,resc4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_b_dialog_capacidad);
        mostrar_hab();
    }
    private void mostrar_hab() {
        ...
        btncapa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(B_dialog_capacidad.this,B_A4_Diagnostico.class);
