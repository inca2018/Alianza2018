...
public class S_dialog_social2 extends AppCompatActivity {

    int so1,so2,so3,so4;
    ImageView regresar3,vaciar3;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_s_dialog_social2);

        regresar3=(ImageView)findViewById(R.id.toolbar_boton_volver_soc2);
        vaciar3=(ImageView)findViewById(R.id.toolbar_boton_vaciar_soc2);

        mostrar_hab();
        regresar3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(S_dialog_social2.this,B2_Evaluacion2.class);
    ...
    private void mostrar_hab() {
        ...
        final RadioButton rso10=(RadioButton)findViewById(R.id.rso10z);
        final RadioButton rso11=(RadioButton)findViewById(R.id.rso11z);
        final RadioButton rso12=(RadioButton)findViewById(R.id.rso12z);
        final RadioButton rso13=(RadioButton)findViewById(R.id.rso13z);
        final RadioButton rso20=(RadioButton)findViewById(R.id.rso20z);
        final RadioButton rso21=(RadioButton)findViewById(R.id.rso21z);
        final RadioButton rso22=(RadioButton)findViewById(R.id.rso22z);
        final RadioButton rso23=(RadioButton)findViewById(R.id.rso23z);
        final RadioButton rso30=(RadioButton)findViewById(R.id.rso30z);
        final RadioButton rso31=(RadioButton)findViewById(R.id.rso31z);
        final RadioButton rso32=(RadioButton)findViewById(R.id.rso32z);
        final RadioButton rso33=(RadioButton)findViewById(R.id.rso33z);
        final RadioButton rso40=(RadioButton)findViewById(R.id.rso40z);
        final RadioButton rso41=(RadioButton)findViewById(R.id.rso41z);
        final RadioButton rso42=(RadioButton)findViewById(R.id.rso42z);
        final RadioButton rso43=(RadioButton)findViewById(R.id.rso43z);

        final RadioGroup rgso1=(RadioGroup)findViewById(R.id.rgso1z);
        final RadioGroup rgso2=(RadioGroup)findViewById(R.id.rgso2z);
        final RadioGroup rgso3=(RadioGroup)findViewById(R.id.rgso3z);
        final RadioGroup rgso4=(RadioGroup)findViewById(R.id.rgso4z);

        final Button btn3=(Button)findViewById(R.id.btnSocz);
        ...
        vaciar3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                check_variables(0, rso10, rso11, rso12, rso13);
                check_variables(0, rso20, rso21, rso22, rso23);
                check_variables(0, rso30, rso31, rso32, rso33);
                check_variables(0, rso40, rso41, rso42, rso43);
                Snackbar.make(v,"Opciones Sociales deseleccionadas", Snackbar.LENGTH_LONG)
                        .show();
            }
        });
